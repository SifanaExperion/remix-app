import {
  ...
  export default function SettingsPage() {
    ...
    {!submit&& <BlockStack gap={{ xs: "800", sm: "400" }}>
            ...
            <Card roundedAbove="sm">
              <Form method="POST">
                <BlockStack gap="400">
                  ...
                  <Button onClick={()=>setSubmit(true)} submit={true}>Save</Button>
                </BlockStack>
              </Form>
            </Card>
          </InlineGrid>
        ...
        {submit&&<Box 
              as="section"
              paddingInlineStart={{ xs: 200, sm: 0 }}
              paddingInlineEnd={{ xs: 200, sm: 0 }}
            >
              <BlockStack gap="200">
                <Text as="p" variant="bodyMd">
                  App settings and preferences has been updated 
                </Text>
              </BlockStack>
            </Box>}
      </Page>
